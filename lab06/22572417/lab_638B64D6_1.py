...
def main():
    ...
    print("Mammal {} has {} legs.".format(obj_cat._name,obj_cat._leg_count))
    print("Mammal {} has {} legs.".format(obj_dog._name,obj_dog._leg_count))
    print("Mammal {} has {} legs.".format(obj_human._name,obj_human._leg_count))
